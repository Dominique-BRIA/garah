...
\newcommand{\num}[1]{%
  \tikz[baseline=(n.base)]{
    \node[circle,fill=garahPrimaire,text=white,inner sep=1.2pt,
          font=\scriptsize\bfseries,minimum size=12pt] (n) {#1};}%
}
\newcommand{\numAlt}[1]{%
  \tikz[baseline=(n.base)]{
    \node[circle,fill=garahAlerte,text=white,inner sep=1.2pt,
          font=\scriptsize\bfseries,minimum size=12pt] (n) {#1};}%
}
...
\newtcolorbox{objectif}{
  breakable, enhanced, colback=garahMarque!6, colframe=garahMarque,
...
\newtcolorbox{avant}{
  breakable, enhanced, colback=garahFond, colframe=garahBordure,
...
\newtcolorbox{attention}{
  breakable, enhanced, colback=garahDanger!6, colframe=garahDanger,
  boxrule=0.9pt, arc=3pt, left=9pt, right=9pt, top=7pt, bottom=7pt,
...
\newtcolorbox{astuce}{
  breakable, enhanced, colback=garahSucces!7, colframe=garahSucces,
  boxrule=0.9pt, arc=3pt, left=9pt, right=9pt, top=7pt, bottom=7pt,
...
\newtcolorbox{retenir}{
  breakable, enhanced, colback=garahAccent!6, colframe=garahAccent,
  boxrule=0.9pt, arc=3pt, left=9pt, right=9pt, top=7pt, bottom=7pt,
...
\newtcolorbox{resultat}{
  breakable, enhanced, colback=garahSucces!5, colframe=garahSucces!70,
  boxrule=0.9pt, arc=3pt, left=9pt, right=9pt, top=7pt, bottom=7pt,
...
\newtcolorbox{exercice}{
  breakable, enhanced, colback=garahAlerte!7, colframe=garahAlerte,
  boxrule=0.9pt, arc=3pt, left=9pt, right=9pt, top=7pt, bottom=7pt,
...
\newtcolorbox{roleBox}{
  breakable, enhanced, colback=garahPrimaire!5, colframe=garahPrimaire,
...
\newtcolorbox{checklist}{
  breakable, enhanced, colback=white, colframe=garahEncre,
